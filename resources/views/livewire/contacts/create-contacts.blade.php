     ...
     <div>
          ...
          <div class="mt-10 p-8 border border-gray-200 rounded">
               ...
               <form wire:submit="addContact" autocomplete="off" novalidate>
                    @csrf
                              ...
                              {{-- <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                                   ...
                                   <div class="mt-2 sm:col-span-2 sm:mt-0">
                                        <select wire:model="form.client_id" class="border border-gray-200 w-full text-gray-500 text-sm rounded-md block pl-1 py-1.5 focus:outline-none sm:max-w-xs sm:text-sm sm:leading-6">
                                             <option value="" selected="selected">Non affecté</option>
                    ...
                    <div class="mt-10 flex items-center justify-center">
                         <button type="submit" class="py-2 px-6 rounded font-normal text-sm text-white bg-slate-500 hover:bg-slate-500/90">Enregistrer</button>
                    </div>
               </form>
          </div>
